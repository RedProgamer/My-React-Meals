...
function Navbar() {
    ...
    return (
            <header className="flex justify-evenly items-center p-2 fixed bg-white opacity-96 shadow-sm backdrop-blur-8 z-101 w-full">
                ...
                <div className="flex flex-1 w-1/2 items-center space-x-5 justify-center">
                    <button className="flex w-10 mr-3">
                        <a href="#menu">Menu</a>
                    </button>
                    ...
                    <button className="flex min-w-md:hidden">
